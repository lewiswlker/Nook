package com.hku.nook.service.websocket;

import com.alibaba.fastjson.JSONObject;
import com.hku.nook.domain.Danmu;
import com.hku.nook.domain.constant.UserMomentsConstant;
import com.hku.nook.service.DanmuService;
        ...
        if (!StringUtil.isNullOrEmpty(message)) {
            try {
                ...
                for (Map.Entry<String, WebSocketService> entry : WEBSOCKET_MAP.entrySet()) {
                    ...
                    DefaultMQProducer danmusProducer = (DefaultMQProducer) APPLICATION_CONTEXT
                            .getBean("danmusProducer");
