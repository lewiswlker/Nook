...
import com.hku.nook.dao.repository.UserInfoRepository;
import com.hku.nook.dao.repository.VideoRepository;
...
public class ElasticSearchService {
    ...
    public List<Map<String, Object>> getContents(String keyword,
        ...
        MultiMatchQueryBuilder matchQueryBuilder = QueryBuilders.multiMatchQuery(keyword, "title", "nick",
                "description");
    ...
    public List<Map<String, Object>> searchVideos(String keyword, Integer limit) throws IOException {
