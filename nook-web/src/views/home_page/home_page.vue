<template>
	<div class="home-wrap">
		...
		<div class="video-wrap" v-if="hasVideo">
		...
		<!-- 视频列表 -->
		<div class="area-wrap">
			<div class="area-list" v-if="videoData['0'] && videoData['0'].length">
			...
			<div class="area-list" v-if="videoData['1'] && videoData['1'].length">
			...
			<div class="area-list" v-if="videoData['2'] && videoData['2'].length">
...
export default {
	...
	computed: {
		hasVideo() {
			return Object.values(this.videoData).some((list) => Array.isArray(list) && list.length);
		}
	},
	data() {
		return {
